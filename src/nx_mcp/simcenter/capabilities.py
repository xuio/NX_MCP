    ...
    return {
        ...
        "unresolved_native_findings": [
            ...
            },
            {
                ...
                "numerical_acceptance": "200-element two-block physical artifact checks pass; automatic stopping criterion unverified; current unsaved session freshness not verified",
                "licence_availability": "not_established_for_solve",
                "next_step": "Verify explicitly selected thermal convergence controls; preserve physical benchmark and unresolved whole-model freshness",
                ...
                "numerical_evidence": "tests/simcenter/evidence/contact-numerical-acceptance.json",
