...
async def main():
    ...
    receipt = {"responses": {}}
    output = shared / "public-25c-prepare-r1.json"
    ...
    async with (
        ...
        result = await call(
            ...
            {
                "cad_document": cad,
                "folder": "ui-benchmarks/public-analysis-25c-r1",
                "name": "Public coupled",
                "operation_id": "public-analysis-create-25c-r1",
            },
        )
        sid = result["sim"]["id"]
        await call(
        ...
        inlet = await call(
            ...
            "nx_sim_inlet",
            {
                ...
                "name": "Public inlet",
                "velocity_m_s": 1.0,
                "operation_id": "public-inlet-25c-r1",
            },
        )
        outlet = await call(
            "opening",
            "nx_sim_opening",
            {
                ...
                "name": "Public outlet",
                "pressure_pa": 101325.0,
                "operation_id": "public-opening-25c-r1",
            },
        )
        await call(
            "external",
        ...
        await call(
            "mesh",
            "nx_sim_mesh_plan",
            {"document": fid, "regions": plan, "operation_id": "public-two-body-mesh-25c-r1"},
        )
        await call(
            "solid",
            "nx_sim_material",
        ...
        prepared = await call(
            ...
            "nx_sim_prepare_solve",
            {
                ...
                "operation_id": "public-user-cad-25c-prepare-r1",
            },
        )
        receipt.update(
