...
async def main():
    ...
    async with (
        ...
        output = Path(r"Z:\nx-mcp-integration\simcenter-discovery\stdio-auto-observer-finish.json")
        ...
        while True:
            status = await client.call_tool(
                "nx_sim_job_status", {"job_id": "auto-observed-flow-01", "include_evidence": True}
            )
        ...
        release = await client.call_tool(
            "nx_sim_release_job",
            {"job_id": "auto-observed-flow-01", "operation_id": "auto-observer-release-01"},
        )
        ...
        audit = await client.call_tool(
            "nx_sim_flow_log",
            {
                ...
                "log_name": "auto_flow_r1-Flow_benchmark.log",
                "limit": 1,
            },
        )
