...
async def main():
    ...
    receipt = {"responses": {}}
    output = shared / "public-full-launch-r1.json"
    ...
    async with (
        ...
        await call(
            ...
            "nx_sim_launch",
            {
                ...
                "operation_id": "public-full-launch-r1",
            },
        )
        await call(
            "observe",
            "nx_sim_observe_job",
            {"job_id": "public-full-coupled-r1", "maximum_seconds": 300},
        )
        receipt.update(passed=True, solver_launched=True, job_id="public-full-coupled-r1")
        record()
