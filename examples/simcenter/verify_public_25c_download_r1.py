...
async def main():
    ...
    receipt = {"responses": {}}
    output = shared / "public-25c-download-r1.json"
    ...
    async with (
        ...
        prepared = json.loads((shared / "public-25c-run-prepare-r1.json").read_text())["responses"][
            "prepare"
        ]["structuredContent"]
        meta = await call(
        ...
        with (shared / "public-25c-input-r1.xml").open("xb") as stream:
            while True:
