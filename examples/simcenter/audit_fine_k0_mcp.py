...
async def main():
    ...
    async with (
        ...
        output = Path(r"Z:\nx-mcp-integration\simcenter-discovery\stdio-fine-k0-finish.json")
        ...
        while True:
            status = await client.call_tool(
                "nx_sim_job_status", {"job_id": "fine-k0-flow-01", "include_evidence": True}
            )
        ...
        release = await client.call_tool(
            "nx_sim_release_job",
            {"job_id": "fine-k0-flow-01", "operation_id": "fine-k0-release-01"},
        )
        ...
        audit = await client.call_tool(
            "nx_sim_flow_log",
            {
                ...
                "log_name": "fine_k0_solve_r1-Flow_benchmark.log",
                "limit": 1,
            },
        )
