...
def run(executor):
    ...
    expected = executor.workspace.resolve(
        "ui-benchmarks/orthotropic-rotated-solve-20260908-r1/rotated_ortho_solve_r1.sim"
    )
    ...
    result = executor._sim_show_temperature(ref, name="Rotated orthotropic conduction - temperature (C)")
    ...
    log = executor.workspace.resolve(
        "ui-benchmarks/orthotropic-rotated-solve-20260908-r1/rotated_ortho_solve_r1-Conduction.log"
